package com.study.eureka_client.task;

import com.study.eureka_client.feign.AuthQuery;
...
import com.study.eureka_client.feign.AuthRemoteClient;
...
public class TokenScheduledTask {
	...
	public void reloadApiToken() {
		...
		System.setProperty("study.auth.token", token);
